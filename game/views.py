...
class AuthController:
    def login(self, request, user: User):
        ...
        return redirect('home')  # Assuming 'home' is defined in your URLs.
...
def add_email_view(request, game_id):
    ...
    email = Email.objects.create(subject="New Offer", content="This is a spam email.", sender="scammer@example.com")
    ...
    dummy_score = Score.objects.filter(pk=game_id).first() or Score.objects.create(value=0)
